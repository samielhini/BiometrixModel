 ...
 *           &lt;element name="MeasureUnit" type="{http://release.niem.gov/niem/codes/unece_rec20/3.0/}MassCodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/sequence>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class WeightMeasureType {
    ...
    protected List<MassCodeType> measureUnit;
     ...
     * 
     */
    public List<MassCodeType> getMeasureUnit() {
        if (measureUnit == null) {
            measureUnit = new ArrayList<MassCodeType>();
        }
